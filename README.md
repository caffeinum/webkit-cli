...
- A ref is only a handle, and it knows nothing about what clicking does. Read the label before you click. On browser-use, for example, the header button "Copy a new API key" issues a new key on every click.
